...
from eglhandler.src.navis import navis_gui_func as nf
...
def voyage_does_not_exist(data: dict, db_file: str) -> None:
        ...
        lb = "\n"
        print(f"{lb}Voyage {data['navis_voy']} does not exist,{lb}"
                f"{str(data['booking_no'])} is saved to database and moved to {EGL_ABSENT_VOYAGE} folder.")
